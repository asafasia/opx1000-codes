"""Class-based v2 migration for 07_iq_blobs_separate."""
...
def acquire_state(
    node: Any, qmm, config: dict, state: str
) -> xr.Dataset:
...
class IqBlobsSeparate(BaseCalibration[Parameters, Quam]):
    """v2 class migration for ``calibrations/07_iq_blobs_separate.py``."""
