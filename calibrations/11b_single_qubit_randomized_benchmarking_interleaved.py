"""Class-based calibration for interleaved single-qubit randomized benchmarking."""
...
class SingleQubitRandomizedBenchmarkingInterleaved(BaseCalibration[Parameters, Quam]):
    """Interleaved single-qubit randomized benchmarking using the calibration lifecycle."""
