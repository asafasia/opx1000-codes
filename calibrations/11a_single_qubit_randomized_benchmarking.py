"""Class-based calibration for 11a_single_qubit_randomized_benchmarking."""
...
class SingleQubitRandomizedBenchmarking(BaseCalibration[Parameters, Quam]):
    """Class-based calibration for ``calibrations/11a_single_qubit_randomized_benchmarking.py``."""
