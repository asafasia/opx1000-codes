"""Class-based calibration for 03a_qubit_spectroscopy."""
...
class QubitSpectroscopy(BaseCalibration[Parameters, Quam]):
    """Class-based calibration for ``calibrations/03a_qubit_spectroscopy.py``."""
...
if __name__ == "__main__":
    ...
    parameters.operation_amplitude_factor = 0.04
    parameters.operation_len_in_ns = 30000
    parameters.frequency_span_in_mhz = 10
    parameters.frequency_step_in_mhz = 0.06
